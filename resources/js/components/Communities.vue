        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-stretch community">
                ...
                <div class="text col-lg-8">
                    <div class="text-inner d-flex align-items-center">
                        <div class="content">
                            <a href="post.html" class="animsition-link">
                                <h2 class="h4">Здоровье будущей мамы</h2></a>
            ...
            <div class="row d-flex align-items-stretch community">
                ...
                <div class="text col-lg-8">
                    <div class="text-inner d-flex align-items-center">
                        <div class="content">
                            <a href="post.html" class="animsition-link"><h2 class="h4">Дети до года</h2></a>
            ...
            <div class="row d-flex align-items-stretch community">
                ...
                <div class="text col-lg-8">
                    <div class="text-inner d-flex align-items-center">
                        <div class="content">
                            <a href="post.html" class="animsition-link">
                                <h2 class="h4">Дети от 1 года до 3 лет</h2></a>
